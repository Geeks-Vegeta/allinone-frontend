...
const JpegToPng=()=>{
    ...
    const convertIcon = async()=>{
        ...
        try {
            const convert = await axios(
                {
                    method:"post",
                    url:"https://allinoneapis.herokuapp.com/jpegtopng",
                    data:data
                }
            )
            console.log(convert);
    ...
    return (
        ...
        <Helmet>
            <title>AllInOne - jpegtopng</title>
            <meta name="description" content="you can convert your jpeg image in png" />
        </Helmet>



        <MDBContainer className="my-4">
            <h1 className="text-center">Jpeg To Png Converter</h1>
