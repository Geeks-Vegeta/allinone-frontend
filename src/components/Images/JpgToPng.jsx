...
const JpgToPng=()=>{
    ...
    return (
        <>
        <Helmet>
            <title>AllInOne - jpgtopng</title>
            <meta name="description" content="you can convert your jpg image in png" />
        </Helmet>
        <MDBContainer className="my-4">
            <h1 className="text-center">Jpg To Png Converter</h1>
            <p className="text-center">Make sure you have <b>JPG</b> format image to convert into png.</p>
