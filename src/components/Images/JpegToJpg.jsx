...
const JpegToJpg=()=>{
    ...
    const ProfileInput=(e)=>{
        ...
        if(isFileLoaded){
            if(isFileLoaded.type === "image/jpeg"){
                ...
                toast.error('Jpeg Format Image Only', {
                    position: "top-center",
                    autoClose: 5000,
    ...
    const convertIcon = async()=>{
        ...
        try {
            const convert = await axios(
                {
                    method:"post",
                    url:"https://allinoneapis.herokuapp.com/jpegtojpg",
                    data:data
                }
            )
            console.log(convert);
            ...
            a.download = "download.jpg"; //File name Here
    ...
    return (
        ...
        <Helmet>
            <title>AllInOne - jpegtojpg</title>
            <meta name="description" content="you can convert your jpeg image in jpg" />
        </Helmet>
        <MDBContainer className="my-4">
            <h1 className="text-center">Jpeg To Jpg Converter</h1>
            <p className="text-center">Make sure you have <b>JPEG</b> format image to convert into jpg.</p>
            <p className="text-center">Some of the JPEG format won't work reason don't know</p>
