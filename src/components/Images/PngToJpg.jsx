...
const PngToJpg=()=>{
    ...
    return (
        <>
        <Helmet>
            <title>AllInOne - pngtojpg</title>
            <meta name="description" content="you can convert your png image in jpg" />
        </Helmet>
        <MDBContainer className="my-4">
            <h1 className="text-center">Png To Jpg Converter</h1>
            <p className="text-center">Make sure you have <b>PNG</b> format image to convert into Jpg.</p>
