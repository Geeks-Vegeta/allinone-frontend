...
const JpgToJpeg=()=>{
    ...
    const ProfileInput=(e)=>{
        ...
        if(isFileLoaded){
            if(isFileLoaded.type === "image/jpeg"){
                ...
                toast.error('Jpg Format Image Only', {
                    position: "top-center",
                    autoClose: 5000,
    ...
    return (
        <>
        <Helmet>
            <title>AllInOne - jpgtojpeg</title>
            <meta name="description" content="you can convert your jpg image in jpeg" />
        </Helmet>

        <MDBContainer className="my-4">
            <h1 className="text-center">Jpg To Jpeg Converter</h1>
            <p className="text-center">Make sure you have <b>JPG</b> format image to convert into jpeg.</p>
